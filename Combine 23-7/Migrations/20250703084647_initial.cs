        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckedByName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CheckedByDesignation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CheckedByDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CheckedBySignatureData = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AcknowledgedByName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AcknowledgedByDesignation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AcknowledgedByDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AcknowledgedBySignatureData = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VerifiedByName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VerifiedByDesignation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VerifiedByDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    VerifiedBySignatureData = table.Column<string>(type: "nvarchar(max)", nullable: true),
