...
namespace AspnetCoreMvcFull.Models.ViewModels
{
  ...
  public class UserEditViewModel
  {
    ...
    // NEW: Property to hold the user's active status
    [Display(Name = "Active Status")]
    public bool IsActive { get; set; } // <--- ADD THIS LINE

    [Display(Name = "Tenant")]
    public string TenantId { get; set; } // The selected tenant for this user
    public List<SelectListItem> AvailableTenants { get; set; } = new List<SelectListItem>(); // Options for the dropdown
